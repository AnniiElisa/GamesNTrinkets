...
export default class Game extends Phaser.Scene
{
    ...
    preload()
    {
        ...
        this.load.image('go-background', 'assets/bunny-gameover3.png')
    ...
    update(t, dt)
    {
        ...
        {
        //stops movement if neither of above is happening
            this.player.setVelocityX(0)
        }
        
        //when jumping off the side, player comes back from the other 
